...
VALUES
  ...
  ('Pienso gato adulto', 'Receta salmùn y arroz, bolsa 8 kg.', 'alimento', 389.00, 28),
  ...
  ('Shampoo hipoalergÈnico', 'Para baÒo frecuente en pieles sensibles, 500 ml.', 'higiene', 165.00, 36),
  ('ArnÈs reflectante M', 'ArnÈs acolchado talla mediana, varios colores.', 'accesorios', 249.00, 22),
